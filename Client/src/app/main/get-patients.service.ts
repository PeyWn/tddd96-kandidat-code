...
export class GetPatientsService {
  ...
  constructor() {
    this.patients = [
      new Patient('Tor', 902391, 'hickar för mycket', 'BE321', 'AKUT', 20, 'ABC123', 33, 24, 3, 'Jätteduktig', 'Sal 3', true),
      new Patient('Björn', 900000, 'Magont', 'BE312', 'Elektiv', 200, 'ABC123', 33, 24, 3, 'Jätteduktig', 'Sal 3', true),
